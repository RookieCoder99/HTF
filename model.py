...
from utils import seq_gather, extract_items, metric,extract
...
class Evaluate(Callback):
    def __init__(self, subject_model, object_model, tokenizer, id2rel, eval_data, save_weights_path, min_delta=1e-4, patience=17):
    ...
    #     triples=extract(path, self.subject_model, self.object_model, self.tokenizer, self.id2rel)
    #     print(triples)
