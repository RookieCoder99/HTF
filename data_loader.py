...
class data_generator:
    ...
    def __iter__(self):
        while True:
            ...
            obj_head_batch, obj_tail_batch=[],[]
            descrip_heads_batch,descrip_tails_batch=[],[]
            for idx in idxs:
                line = self.data[idx]
                ...
                for triple in line['triple_list']:
                    ...
                    sub_head_idx = find_head_idx(tokens, triple[0])  ## 开始序号
                    ...
                    if sub_head_idx != -1 and obj_head_idx != -1:
                        ...
                        # descrip_head_idx = find_head_idx(tokens, descrip)
                ...
                if s2ro_map:
                    ...
                    obj_head, obj_tail = s2ro_map.get((sub_head,sub_tail),[])[0][0],s2ro_map.get((sub_head,sub_tail),[])[0][1]
